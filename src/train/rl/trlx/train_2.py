...
model_dir = '/home/cunhuan/code/controllable-readability-summarization/src/train/mnt/hd3/checkpoints/exec-01000'  # select the checkpoint from the prompt-based methods
